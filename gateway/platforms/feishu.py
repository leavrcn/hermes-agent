...
class FeishuAdapter(BasePlatformAdapter):
    ...
    async def send_image_file(
        ...
        **kwargs,
        ...
        try:
            image_key = await self._upload_image_for_card(image_path)
    ...
    async def _send_raw_message(
        ...
        *,
        ...
        # Feishu interactive cards are rejected with 99992402 when created with
        # receive_id_type=thread_id in this gateway path. If no reply anchor is
        # available, create them in the parent chat instead; live replies still
        # use the reply API above and keep thread context.
